...
exports.getTodayPray = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var date, dateObject, year, month, day, todayPray, studentPray, ads, todayPrayContent, date_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                todayPray = _a.sent();
                if (todayPray) {
                    studentPray = todayPray.studentPray, ads = todayPray.ads, todayPrayContent = todayPray.todayPrayContent, date_1 = todayPray.date;
